...
// https://github.com/google/gopacket/blob/master/examples/bidirectional/main.go
package main
...
// maybeFinish will wait until both directions are complete, then print out stats
